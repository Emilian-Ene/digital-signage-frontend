  ...
  <div className={styles.container} id="empty-state">
      ...
      <div className={styles.cardGrid}>
        <div className={styles.card}>
          ...
          <h3 className={styles.cardTitle}>Download the pixelflow.player</h3>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.cardSubtitle}>Launch the pixelflow.player app and copy the displayed PIN code shown on the screen.</p>
        ...
        <div className={styles.card}>
          ...
          <p className={styles.cardSubtitle}>In the PixelFlow app, choose 'New Screen' and enter the PIN to pair the device with your account.</p>
